...
//         String workHours = "M-F 9:00 - 18:00";
    ...
    public void isWithinWorkingHours_currentTimeIsBetWeenOpeningAndClosingTime_TrueReturned() throws ParseException {
        ...
        System.out.println(workingTime.getOpeningTime());
        System.out.println(workingTime.getClosingTime());
        String workHoursCurrent = "10:00";
        Date currentDate = setCurrentDateAsPerTime(workHoursCurrent);
        setCurrentDateAsPerTime(workHoursCurrent);
        Date openingTime = workingTime.getOpeningTime();
        Date closingTime = workingTime.getClosingTime();

        // Act
        boolean result = DateUtils.isWithinWorkingHours(currentDate, openingTime,closingTime);
        // Assert
        assertTrue(result);
    }
    ...
    @Test
    public void shouldDisplayAlertDialogWithMessage_TrueReturned() throws ParseException {
        // Arrange
        ...
        Date currentDate = setCurrentDateAsPerTime("10:00");
        // Act
        boolean result =  DateUtils.isThisTheRightTime(currentDate, configuration);
        // Assert
        assertThat(result, is(true));
    }

    @Test
    public void shouldDisplayAlertDialogWithMessage_FalseReturned() throws ParseException {
        // Arrange
        // TODO : This test result will vary based on the timing you run test. So modify work hours accordingly
        String workHours = "M-F 9:00 - 22:00";
        WorkingTime workingTime = DateUtils.getWorkingTimings(workHours);
        Configuration configuration = new Configuration(true,
                true, workHours, workingTime);
        Date currentDate = setCurrentDateAsPerTime("23:00");
        // Act
        boolean result =  DateUtils.isThisTheRightTime(currentDate, configuration);
        // Assert
    ...
    private Date setCurrentDateAsPerTime(String workHoursCurrent) throws ParseException {
